-- ============================================
-- COMPLETE SMTP SETUP FOR SUPABASE
-- Run this entire script in your Supabase SQL Editor
-- ============================================

-- Step 1: Create SMTP accounts table
...
CREATE TRIGGER update_smtp_accounts_updated_at 
  BEFORE UPDATE ON smtp_accounts
...
-- Step 10: Create RLS policies for smtp_accounts
...
-- Step 11: Create RLS policies for email_campaigns
...
-- Step 12: Create RLS policies for email_queue
...
-- Step 13: Create RLS policies for email_templates
...
AND tablename IN ('smtp_accounts', 'email_campaigns', 'email_queue', 'email_templates');
...
FROM pg_policies
WHERE tablename IN ('smtp_accounts', 'email_campaigns', 'email_queue', 'email_templates')
GROUP BY tablename;

-- Success message
SELECT '✅ SMTP tables created successfully! You can now add Gmail SMTP accounts.' as status;
